...
QT_MOC_LITERAL(3, 26, 6) // "source"

    },
    "ImageModel\0sourceChanged\0\0source"
};
...
void ImageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageModel::sourceChanged)) {
                *result = 0;
                return;
            }
        }
